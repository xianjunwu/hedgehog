...
public class AdminCommentController {
	...
	@ResponseBody
	public DataGridResult<Commont> pageQuery(Integer page, Integer recPerPage, String search, String sortBy, String order) {
		DataGridBo<Commont> dataGridBo = commontService.pageQuery(page, recPerPage, search, sortBy, order);
