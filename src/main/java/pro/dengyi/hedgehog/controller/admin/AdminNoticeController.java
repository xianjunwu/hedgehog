...
public class AdminNoticeController {
	...
	@ResponseBody
	public DataGridResult<Notice> pageQuery(Integer page, Integer recPerPage, String search, String sortBy, String order) {
		DataGridBo<Notice> dataGridBo = noticeService.pageQuery(page, recPerPage, search, sortBy, order);
