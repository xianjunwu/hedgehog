...
+function ($, window, document) {
  ...
  Sortable.prototype.init = function () {
    ...
    var markOrders = function ($items) {
      ...
      if (itemsCount) {
        $items.each(function (itemIndex) {
          ...
          $(this).attr('data-' + STR_ORDER, itemOrder).data(STR_ORDER,
              itemOrder);
        });
      }
    };
    ...
    $root.droppable({
      ...
      target: targetSelector ? targetSelector : (containerSelector ? (selector
      ...
      start: function (e) {
        if (dragCssClass) {
          e.element.addClass(dragCssClass);
        }
        orderChanged = false;
      ...
      finish: function (e) {
        if (dragCssClass && e.element) {
          e.element.removeClass(dragCssClass);
        }
  ...
  $.fn.sortable = function (option) {
    return this.each(function () {
      ...
      if (!data) {
        $this.data(NAME, (data = new Sortable(this, options)));
