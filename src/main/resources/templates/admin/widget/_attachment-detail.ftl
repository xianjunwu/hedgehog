            ...
            <div class="box box-solid">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="box-footer">
                        ...
                        <button type="button" class="btn btn-info btn-sm pull-right btn-copy" data-clipboard-text="${pwebOptions.blog_url?if_exists}${attachment.attachPath}"><@spring.message code='admin.attachments.modal.form.btn.copy-path' /></button>
                    </div>
                </form>
            </div>
        </div>
