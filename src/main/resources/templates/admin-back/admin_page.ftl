...
<@head>${pwebOptions.blog_title} | <@spring.message code='admin.pages.title' /></@head>
<div class="wrapper">
    <!-- 顶部栏模块 -->
                                    ...
                                    <table class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th><@spring.message code='common.th.title' /></th>
                                                <th><@spring.message code='common.th.url' /></th>
                                                <th><@spring.message code='common.th.pwebArticleComments' /></th>
                                        ...
                                        <#if pages?size gt 0>
                                            <#list pages as page>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="label" style="background-color: #d6cdcd;">${page.pwebArticleComments?size}</span>
                                                    </td>
                                                    <td>
