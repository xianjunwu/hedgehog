...
<@head>${pwebOptions.blog_title} | <@spring.message code='admin.pages.edit.title' /></@head>
<div class="wrapper">
    <!-- 顶部栏模块 -->
            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <div style="display: block;margin-bottom: 10px;">
                        <span>
                            ...
                            <a href="#">${pwebOptions.blog_url}/p/<span id="postUrl"><#if post??>${post.postUrl}</#if></span>/</a>
                ...
                <div class="col-md-3">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <label for="allowComment" class="control-label"><@spring.message code='admin.editor.allow-pwebArticleComment' /></label>
