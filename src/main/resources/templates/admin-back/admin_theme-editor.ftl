...
<@head>${pwebOptions.blog_title} | <@spring.message code='admin.themes.edit.title' /></@head>
<div class="wrapper">
    <!-- 顶部栏模块 -->
        ...
        <section class="content container-fluid">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">${pwebOptions.theme?default('halo')}主题</h3>
                        </div>
                                            ...
                                            <tr style="cursor: pointer">
                                                ...
                                                <td class="mailbox-subject">
                                                    <#switch tpl>
                                                        ...
                                                        宏模板
                                                        <#break >
                                                        <#case "pwebArticleTag.ftl">
                                                        单个标签页面
                                                        <#break >
                                                        <#case "pwebArticleTags.ftl">
                                                        标签列表页面
                                                        <#break>
                                                        <#case "pwebArticleCategory.ftl">
                                                        单个分类页面
                                                        <#break >
                                                        <#case "page.ftl">
                                                        自定义页面
