    ...
    <div class="login-body animated">
        <form>
            <div class="form-group animated fadeInUp" style="animation-delay: 0.1s">
                <input type="text" class="form-control" name="loginName" id="login-name"
                       placeholder="邮箱">
            </div>
            <div class="form-group animated fadeInUp" style="animation-delay: 0.2s">
                <input type="password" class="form-control" name="loginPwd" id="login-pwd"
                       placeholder="密码">
            </div>
            ...
            <button type="button" id="btn-login"
                    class="btn btn-block login-button animated fadeInUp"
                    onclick="btn_login()"
                    style="animation-delay: 0.4s;outline: none;">登录
            </button>
        </form>
    </div>
</div>
