                                ...
                                <div class="form-group animated fadeInUp" style="animation-delay: 0.1s">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" id="blogLocale" name="blogLocale">
                                            <option value="zh_CN" ${((pwebOptions.blog_locale?default('zh_CN'))=='zh_CN')?string('selected','')}>简体中文</option>
                                            <option value="en_US" ${((pwebOptions.blog_locale?if_exists)=='en_US')?string('selected','')}>English</option>
                                        </select>
                                    </div>
                                </div>
